...
- 已确认设计第 8、11、12.2 节。
- 当前科学语义说明：[`Adversarial MLP 科研协议`](../research/adversarial-mlp-protocol.md)。
...
- YAML 必须逐项转录并密封 [`Adversarial MLP 科研协议`](../research/adversarial-mlp-protocol.md)
...
- [x] [`Adversarial MLP 科研协议`](../research/adversarial-mlp-protocol.md) 所说明的训练边界
