...
from higgsml.modeling.discriminants import digest, _validate_frame
...
def require_raw_calibration_bundle(bundle, loaded):
    from higgsml.sample_efficiency.lineage import require_experiment_lineage
    from higgsml.sample_efficiency.training import require_loaded_subset_discriminant
...
def build_raw_calibration_bundle(prepared, loaded, protocol, *, transform="raw"):
    ...
    from higgsml.sample_efficiency.training import load_bound_prepared_role, predict_subset_discriminant
    from higgsml.sample_efficiency.lineage import bind_experiment_lineage
