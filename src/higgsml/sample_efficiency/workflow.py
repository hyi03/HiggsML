...
from higgsml.inference.templates import (build_sample_efficiency_template, common_mass_grid,
...
_T1_SCHEMA_PATH = Path(__file__).resolve().parents[3] / "config" / "schemas" / "t1_validation_v1.schema.json"
