...
from higgsml.artifacts import LoadedRun, ResearchRun, read_run
from higgsml.data import load_research_data
from higgsml.modeling.discriminants import ResearchClassifier, digest, train_discriminant
...
from higgsml.sample_efficiency.lineage import ExperimentLineage, _lineage_from_verified_model, require_experiment_lineage
from higgsml.sample_efficiency.protocol import SampleEfficiencyProtocol
from higgsml.sample_efficiency.subsets import TrainingSubset, load_training_subset, summarize_training_rows
...
def predict_subset_discriminant(loaded, frame):
    ...
    from higgsml.modeling.discriminants import _predict_discriminant_payload
