"""Frozen Base14 feature construction."""
...
# Legacy/raw-domain leakage guard retained for behavior equivalence. The sealed
# preprocessing protocol's forbidden_features list is authoritative for the new
# 32-column artifact-to-model boundary.
FORBIDDEN_FEATURES = {
    "m4l",
    "channelNumber",
    "eventNumber",
