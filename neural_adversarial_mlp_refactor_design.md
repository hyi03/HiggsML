> 版本说明（2026-09-05）：本文保留 v1 历史设计。当前输入、CLI、schema 与事件分组以[软件设计文档](neural/docs/sw-dev/README.md)为准；原物理选择、15 项特征、网络及资格边界继续适用。本文混用输入计数不得用于新配对验收。
...
对抗器精确包含 1,611 个可训练参数，完整模型精确包含 9,228 个可训练参数。
