...
from higgsml.modeling.calibration import digest
from higgsml.errors import ResearchError
from higgsml.sample_efficiency.reporting import publish_sample_efficiency_report
from higgsml.sample_efficiency.controls import (
...
from higgsml.sample_efficiency.workflow import execute_learning_curve
...
def test_disabled_capacity_plan_is_named_and_empty_without_payload_decode(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "higgsml.sample_efficiency.controls.read_training_subsets",
...
def test_both_disabled_controls_skip_public_payload_readers_and_reject_collision(
    ...
    monkeypatch.setattr("higgsml.sample_efficiency.controls.read_learning_curve_batch", sentinel)
    monkeypatch.setattr("higgsml.sample_efficiency.controls.read_sample_efficiency_report", sentinel)
