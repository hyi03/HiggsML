...
def synthetic_four_leptons(count=1800):
    ...
    selection_protocol = load_selection_protocol('config/protocols/h4l_selection_v1.yaml', dataset='atlas2020_4lep')
    selection = SelectionConfig.from_mapping(selection_protocol.selection)
    rows = []
