...
def _bindings(tmp_path, *, poison=False, order_seed=None, draws=(100, 101), fractions=(0.25, 0.5, 1.0)):
    ...
    raw = json.loads((Path(__file__).resolve().parents[2] / "config/protocols/sample_efficiency_v1.json").read_text())
