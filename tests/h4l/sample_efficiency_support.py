...
from higgsml.data import role_for_group, write_research_data
from higgsml.protocol import load_protocol
from higgsml.modeling.representations import representation_features
from higgsml.sample_efficiency.protocol import SampleEfficiencyProtocol, freeze_compact_candidate
from higgsml.sample_efficiency.subsets import publish_training_subsets
...
def build_sample_efficiency_fixture(tmp_path, *, fractions=(0.5, 1.0), draws=(100, 101),
    ...
    raw = json.loads((Path(__file__).resolve().parents[2] /
                      "config/protocols/sample_efficiency_v1.json").read_text(encoding="utf-8"))
