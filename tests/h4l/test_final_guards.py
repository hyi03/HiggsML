...
from higgsml.modeling.matrix_element import _digest
from higgsml.workflow import execute, expected_candidates, _me_binding, _supplement_me_bundles, _frozen_stress_reference, _require_unopened
...
def test_frozen_m1_m1c_cli_supplemental_assessment_lifecycle(tmp_path):
    ...
    from higgsml.data import write_research_data
