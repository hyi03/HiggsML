...
from higgsml.physics import selection as selection_module
from higgsml.physics.angular5 import boost, build_angular5
from higgsml.physics.features import build_candidate_features
from higgsml.physics.four_vectors import FourVector, delta_phi
from higgsml.physics.reconstruction import Lepton, normalize_leptons, pair_four_leptons, reconstruct_candidate
from higgsml.physics.selection import SelectionConfig, select_event
from higgsml.physics.splitting import event_split
from higgsml.physics.weights import physical_event_weight, training_weights
from higgsml.config import InputBindingError, load_selection_protocol
...
def _selection_config() -> SelectionConfig:
    protocol = load_selection_protocol(PROJECT / "config/protocols/h4l_selection_v1.yaml", dataset="atlas2020_4lep")
